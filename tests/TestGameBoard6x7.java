...
public class TestGameBoard6x7 
{
	...
	public void testDiagonalBottomLeftWin() 
	{
		...
		boolean check2 = this.checkEndPoints(new Point(0, 2), new Point(3, 5));
		assertTrue(check1 || check2);
	}
	...
	public void testDiagonalBottomRightWin() 
	{
		...
		boolean check2 = this.checkEndPoints(new Point(6, 2), new Point(3, 5));
		assertTrue(check1 || check2);
	}
	...
	public void testDiagonalBottomMiddleWin() 
	{
		...
		boolean check2 = this.checkEndPoints(new Point(5, 2), new Point(2, 5));
		assertTrue(check1 || check2);
	}
